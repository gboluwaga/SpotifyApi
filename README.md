# SpotifyApi
ETL Using the Spotify API

This project covers the entire ETL process based on Spotify API data. 

I built a simple data pipeline (or in other words, a data feed) that downloads Spotify data
